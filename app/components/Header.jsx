  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
       <div className='flex justify-between items-center'>
        <Image src={assets.logo} width={180} alt='Not Available' className="w-[130px] sm:w-auto"/>
        <button className='flex items-center  py-1 px-3 sm:py-3 sm:px-6 border gap-2 font-medium border-black border-solid shadow-[-7px_7px_0px_#000000] hover:bg-slate-100 focus:bg-slate-200'>Get Started <Image src={assets.arrow}/></button>
       </div>
